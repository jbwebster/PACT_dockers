			...
			if "##" in line:
				...
				for s in samples:
					...
					try:
						...
						if alr_reads / dp > 0.001:
							supporting_samples += 1
					except:
						supporting_samples += 0 #Do nothing
...
def main(args):
	...
	parser.add_argument("-p", "--percent", action="store", default=10, type=int, help="Maximum percent of samples allows to support a variant. Default=10")
